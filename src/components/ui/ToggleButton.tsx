    ...
    return (
        <button
            className={cn(
                ...
                "data-[state=on]:text-front data-[state=on]:bg-back-alt/60 data-[state=on]:border-front/5",
                "hover:bg-back-alt/30 hover:text-front/50 hover:data-[state=on]:bg-back-alt/40",
                className)}
            type="button"
